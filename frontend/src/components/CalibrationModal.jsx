                    ...
                    >
                        <div className={isSubmitted ? "p-4" : "p-10 md:p-12"}>
                            ...
                            {!isSubmitted ? (
                                ...
                                <div className="relative w-full h-[700px] overflow-hidden rounded-3xl bg-white mt-4 border-8 border-[#0c0f16]">
                                    <iframe
                                        ...
                                        className="absolute inset-x-0 top-0 w-full h-[calc(100%+100px)] border-none"
