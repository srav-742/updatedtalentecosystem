        ...
        >
            <div className="container mx-auto px-6 py-4 flex items-center justify-between">
                ...
                <Link to="/" className="flex items-center space-x-2 group shrink-0">
                    <div className="w-10 h-10 rounded-xl overflow-hidden bg-[#0c0f16] flex items-center justify-center shadow-lg shadow-blue-500/20 border border-white/10 group-hover:scale-110 transition-transform">
                        <img 
                            src="/logo.png" 
