...
import { Briefcase, MapPin, Users, Trash2, Edit3, ArrowUpRight, Search, Filter, Clock, CheckCircle2, XCircle, AlertCircle, Share2, Mail, Linkedin, Twitter, Copy, UploadCloud, Code2 } from 'lucide-react';
                                    ...
                                    <div className="flex flex-col gap-3">
                                        ...
                                        <div className="flex items-center gap-2 mt-1">
                                            ...
                                            {job.codingAssessment?.enabled && (
                                                <span className="text-teal-400 bg-teal-500/10 px-2 py-1 rounded-md border border-teal-500/20 text-[10px] font-bold uppercase">
                                                    {job.codingAssessment.passingScore || 70}% Coding
                                                </span>
                                            )}
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        {job.codingAssessment?.enabled && (
                                            <button
                                                ...
                                                className="p-3.5 rounded-2xl bg-white/5 border border-white/5 hover:bg-teal-500/10 transition-all group/btn"
                                                title="Configure Coding Assessment"
                                            >
                                                <Code2 size={20} className="text-gray-400 group-hover/btn:text-teal-400" />
                                            </button>
                                        )}
                                        <button
                                            onClick={() => {
