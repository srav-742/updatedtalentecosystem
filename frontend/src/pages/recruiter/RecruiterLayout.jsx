...
import { LayoutDashboard, FilePlus, Briefcase, Users, UserCircle, LogOut, Zap, BarChart3, Package, Sparkles, Crown, ChevronLeft, ChevronRight, Wallet, Plus, FileText, ShieldAlert } from 'lucide-react';
...
const navItems = [
    ...
    { label: 'Proctoring Reports', icon: ShieldAlert, path: '/recruiter/proctoring-reports' },
