...
const PostJob = () => {
        ...
        if (editJobId) {
            const fetchJob = async () => {
                try {
                    ...
                    const job = res.data.find(j => j._id === editJobId);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (editJobId) {
                await axios.put(`http://127.0.0.1:5000/api/jobs/${editJobId}`, dataToSave);
            } else {
                await axios.post('http://127.0.0.1:5000/api/jobs', dataToSave);
            }
